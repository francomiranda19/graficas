...
if __name__ == "__main__":
    ...
    GMcr1 = catmullRomMatrix(P1, P2, P3, P4)
    GMcr2 = catmullRomMatrix(P2, P3, P4, P5)
    ...
    print(catmullRomCurve2)

    # Setting up the matplotlib display for 3D
    fig = mpl.figure()
    ax = fig.gca(projection = '3d')

    plotCurve(ax, catmullRomCurve1, "Catmull-Rom curve 1", (0, 0, 0))
    plotCurve(ax, catmullRomCurve2, "Catmull-Rom curve 2", (1, 0, 0))
